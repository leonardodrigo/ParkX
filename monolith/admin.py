...
class FuncionarioAdmin(admin.ModelAdmin):
    list_display = [
        ...
        'salario', 'data_nascimento', 'data_admissao',
        'criado_em', 'atualizado_em', 'cargo', 'ativo'
    ]
...
class VeiculoAdmin(admin.ModelAdmin):
    list_display = [
        'marca', 'modelo', 'placa',  'cadastrado_em',
        'atualizado_em', 'cor_primaria', 'cor_secundaria',
        'ano', 'proprietario', 'vaga'
    ]
    list_editable = ['vaga']
