...
from monolith.views import index, buttons, cards, utilities_colors, utilities_border, utilities_animation, \
    utilities_other, login, register, forgot_password, not_found, blank, charts, tables
